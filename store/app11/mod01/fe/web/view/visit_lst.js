...
_cp.init = function(){
    _cp.views.page = './app11/fe/mod01/web/view/visit_lst.htm';
    ...
    <table class="table table-sm table-striped" id="tbl_requests">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>ST002</td>
          <td class="text-center">
            <button type="button" class="btn btn-primary btn-sm" onclick='_cp.on.View("9876543220");'>
              <i class="bi bi-eye"></i> View
            </button>
          </td>
        </tr>
        <tr>
          ...
          <td>ST003</td>
          <td class="text-center">
            <button type="button" class="btn btn-primary btn-sm" onclick='_cp.on.View("9876543230");'>
              <i class="bi bi-eye"></i> View
            </button>
          </td>
        </tr>
        <tr>
          ...
          <td>ST004</td>
          <td class="text-center">
            <button type="button" class="btn btn-primary btn-sm" onclick='_cp.on.View("9876543240");'>
              <i class="bi bi-eye"></i> View
            </button>
          </td>
        </tr>
        <tr>
          ...
          <td>ST005</td>
          <td class="text-center">
            <button type="button" class="btn btn-primary btn-sm" onclick='_cp.on.View("9876543250");'>
              <i class="bi bi-eye"></i> View
            </button>
          </td>
        </tr>
